...
namespace web_seed {
	...
	// url_seed (the default) advertises the torrent over a BEP 19 URL seed;
	// this flag switches to a BEP 17 HTTP seed for test_transfer's banner.
	constexpr web_seed_flag_t http_seed = 6_bit;
}
